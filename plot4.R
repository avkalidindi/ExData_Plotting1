...
plot(power_data$DateTime, power_data$Global_active_power, type = "l", main = "", xlab = "", ylab = "Global Active Power")

plot(power_data$DateTime, power_data$Voltage, type = "l", main = "", xlab = "datetime", ylab = "Voltage")
...
plot(power_data$DateTime, power_data$Global_reactive_power, type = "l", main = "", xlab = "datetime", ylab = "Global_reactive_power")
